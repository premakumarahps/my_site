...
const PERSPECTIVES: Perspective[] = [
  {
    ...
    role: "Materials & Computational Engineer",
    institution: "University of Moratuwa · B.Sc. Eng (Hons)",
    quote: "First Principles over Formulas",
    tags: ["Super Duplex SS", "Abaqus FEA", "Continuum Mechanics"],
    auraGradient: "from-sky-500/25 via-blue-500/15 to-indigo-500/25",
  },
  {
    id: "pedagogy",
    label: "Physics & Pedagogy",
    shortLabel: "Physics Mentor",
    icon: Atom,
    imageSrc: "/images/sadun-academic.jpg",
    imageAlt: "Sadun Premakumara on University of Moratuwa campus",
    role: "Physics Academy Lead Mentor",
    institution: "5+ Years Islandwide High-Impact Pedagogy",
    quote: "Demystifying Abstract Physics with Engineering Intuition",
    tags: ["A/L Physics Theory", "Problem Deconstruction", "Islandwide Ranks"],
    auraGradient: "from-emerald-500/25 via-teal-500/15 to-cyan-500/25",
  },
  {
    id: "systems",
    label: "Systems & Modeling",
    shortLabel: "Systems & Data",
    icon: Code2,
    imageSrc: "/images/sadun-research.png",
    imageAlt: "Sadun Premakumara - Analytical Engineering and Computational Modeling",
    role: "Computational Modeler & Systems Designer",
    institution: "Scientific Computing & Full-Stack Architectures",
    quote: "Rigor in Code, Precision in Mechanics",
    tags: ["SciPy / Pandas", "SCAPS-1D", "IoT Microcontrollers"],
